...
/datum/species/anthromorphsmall
	...
	base_name = "Beastvolk"
	use_titles = TRUE
	race_titles = list("Catvolk", "Dogvolk", "Venardvolk", "Ratvolk", "Pigvolk", "Rabbitvolk", "Raccoonvolk", "Red Pandavolk", "Sealvolk", "Hyenavolk", "Coyotevolk", "Jackalvolk", "Batvolk", "Ottervolk", "Monstervolk")
